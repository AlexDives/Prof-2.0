...
namespace SharpUpdate
{
    ...
    /// </summary>
    internal partial class SharpUpdateDownloadForm : MetroFramework.Forms.MetroForm
    {
        /// <summary>
        ...
        internal SharpUpdateDownloadForm(Uri location, string md5, Icon programIcon)
        {
            ...
            // Download file
            //ЕСЛИ ФАЙЛ НЕ ЗАГРУЗИЛСЯ,ТО DIALOGRESULT = NO
        ...
        private void webClient_DownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            this.lblProgress.Text = string.Format("Загружено {0} из {1}", FormatBytes(e.BytesReceived, 1, true), FormatBytes(e.TotalBytesToReceive, 1, true));
        ...
        private void webClient_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                this.lblProgress.Text = "Проверка Загрузки...";
        ...
        private void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (Hasher.HashFile(file, HashType.MD5).ToUpper() != updateMD5.ToUpper())
                //Не знаю,но я принудительно заставляю его обнавлятся 
